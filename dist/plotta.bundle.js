...
var Axis = function Axis(type, visible, label, position, range) {
...
var GraphConfig = function () {
  ...
  var TITLE_FONTSIZE = Symbol('TitleFontSize');
  var LEGEND_FONTSIZE = Symbol('LegendFontSize');
  var LEGEND_LOCATION = Symbol('LegendLocation');
  var GRID_TYPE = Symbol('GridType');
  var GRID_VISIBLE = Symbol('GridVisible');
  var BORDER_TYPE = Symbol('BorderVisible');
  var BORDER_VISIBLE = Symbol('BorderVisible');
  var BORDER_COLOR = Symbol('BorderColor');
  var BORDER_WIDTH = Symbol('BorderWidth');
  var AXIS_COLOR = Symbol('AxisColor');
  var AXIS_WIDTH = Symbol('AxisWidth');
  var AXIS_FONTSIZE = Symbol('AxisFontSize');
  var AXIS_X = Symbol('AxisX');
  var AXIS_X2 = Symbol('AxisX2');
  var AXIS_Y = Symbol('AxisY');
  var AXIS_Y2 = Symbol('AxisY2');
  var TICS_COLOR = Symbol('TicsColor');
  var TICS_FONTSIZE = Symbol('TicsFontSize');
  var TICS_VISIBLE = Symbol('TicsVisible');
  var TICS_VALUE = Symbol('TicsValue');
  ...
  function () {
    ...
    _createClass(GraphConfig, [{
      ...
      value: function Init(config) {
        ...
        if (Object(_util__WEBPACK_IMPORTED_MODULE_0__["IsObject"])(config.legend)) {
        ...
        if (Object(_util__WEBPACK_IMPORTED_MODULE_0__["IsObject"])(config.axis)) {
          ...
          if (Object(_util__WEBPACK_IMPORTED_MODULE_0__["IsObject"])(config.axis.x)) {
            var _config$axis$x = config.axis.x,
                ...
                position = _config$axis$x.position,
                range = _config$axis$x.range;
            this.axisX = new _axis__WEBPACK_IMPORTED_MODULE_1__["default"](type, visible, label, position, range);
          }

          if (Object(_util__WEBPACK_IMPORTED_MODULE_0__["IsObject"])(config.axis.x2)) {
            var _config$axis$x2 = config.axis.x2,
                _type = _config$axis$x2.type,
                _visible = _config$axis$x2.visible,
                _label = _config$axis$x2.label,
                _position = _config$axis$x2.position,
                _range = _config$axis$x2.range;
            this.axisX2 = new _axis__WEBPACK_IMPORTED_MODULE_1__["default"](_type, _visible, _label, _position, _range);
          }

          if (Object(_util__WEBPACK_IMPORTED_MODULE_0__["IsObject"])(config.axis.y)) {
            var _config$axis$y = config.axis.y,
                _type2 = _config$axis$y.type,
                _visible2 = _config$axis$y.visible,
                _label2 = _config$axis$y.label,
                _position2 = _config$axis$y.position,
                _range2 = _config$axis$y.range;
            this.axisY = new _axis__WEBPACK_IMPORTED_MODULE_1__["default"](_type2, _visible2, _label2, _position2, _range2);
          }

          if (Object(_util__WEBPACK_IMPORTED_MODULE_0__["IsObject"])(config.axis.y2)) {
            var _config$axis$y2 = config.axis.y2,
                _type3 = _config$axis$y2.type,
                _visible3 = _config$axis$y2.visible,
                _label3 = _config$axis$y2.label,
                _position3 = _config$axis$y2.position,
                _range3 = _config$axis$y2.range;
            this.axisY2 = new _axis__WEBPACK_IMPORTED_MODULE_1__["default"](_type3, _visible3, _label3, _position3, _range3);
          }
        }
      ...
      set: function set(value) {
        if (value && _typeof(value) === 'object' && value.x && typeof value.x === 'number' && value.y && _typeof(value.y) === 'object') {
...
function () {
  ...
  _createClass(GraphModel, [{
    key: "SetViewHandler",
    value: function SetViewHandler(viewHandeler) {
    ...
    value: function InitModel(dataSet) {
      ...
      dataSet.linedatas.length && dataSet.linedatas.forEach(function (item) {
        ...
        _this.lineDatas.set(id, new _lineData__WEBPACK_IMPORTED_MODULE_1__["default"](type, axisX, axisY, legend, color, visible, datas, func, dotNum));
      });
    ...
    value: function UpdateModel(dataSet) {
      ...
      dataSet.linedatas.length && dataSet.linedatas.forEach(function (item) {
        ...
        if (_this2.lineDatas.has(id)) {
          _this2.lineDatas.get(id).Update(type, axisX, axisY, legend, color, visible, datas, func, dotNum);
        } else {
          _this2.lineDatas.set(id, new _lineData__WEBPACK_IMPORTED_MODULE_1__["default"](type, axisX, axisY, legend, color, visible, datas, func, dotNum));
        }
      });
...
var LineData = function LineData(type, axisX, axisY, legend, color, visible, datas, func, dotNum) {
...
/* harmony import */ var _viewModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./viewModel */ "./src/presenter/viewModel.js");
...
function () {
  function Presenter(graphModel, graphView) {
    ...
    this.ViewModel = new _viewModel__WEBPACK_IMPORTED_MODULE_0__["default"](graphModel);
  ...
  _createClass(Presenter, [{
    key: "_getViewHandeler",
    value: function _getViewHandeler() {
      return {
        UpdateView: function () {
          this.GraphView.UpdateView();
        }.bind(this)
    ...
    key: "_getModelHandeler",
    value: function _getModelHandeler() {
      return {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return GraphCanvas; });
...
function () {
  ...
  _createClass(GraphCanvas, [{
    key: "Draw",
    value: function Draw(viewModel) {
      _draw_drawHelper__WEBPACK_IMPORTED_MODULE_0__["default"].Draw(this.offscreenContext, this.presentationCanvas.width, this.presentationCanvas.height, viewModel);
...
var CanvasHelperFactory = {
  Create: function Create(canvas) {
    ...
    if (_platform_platform__WEBPACK_IMPORTED_MODULE_2__["default"].IsAvailableOffScreen) return new _osCanvasHelper__WEBPACK_IMPORTED_MODULE_1__["default"](canvas);
    return new _canvasHelper__WEBPACK_IMPORTED_MODULE_0__["default"](canvas);
  }
};
...
function () {
  function GraphView(canvas) {
    ...
    this.graphCanvas = _canvasHelperFactory__WEBPACK_IMPORTED_MODULE_0__["default"].Create(canvas);
  ...
  _createClass(GraphView, [{
    ...
    value: function GetEventListener() {
      var EVENT_TYPE = {
        KEYBOARD: 1,
        MOUSE: 2,
        WHEEL: 4,
      ...
      var EventDispatcher = function EventDispatcher(e) {
        switch (e.type) {
          case 'keydown':
            {
              break;
      ...
      var BindEvent = function BindEvent(targetEl, type) {
        if (!targetEl) return;
        var _type = type;
    ...
    key: "SetModelHandler",
    value: function SetModelHandler(modelHandeler) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return OffscreenGraphCanvas; });
/* harmony import */ var _osWorker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./osWorker */ "./src/view/osWorker.js");
/* harmony import */ var _osWorker__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_osWorker__WEBPACK_IMPORTED_MODULE_0__);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function OffscreenGraphCanvas(canvas) {
    ...
    this.worker = new _osWorker__WEBPACK_IMPORTED_MODULE_0___default.a();
  }
...
module.exports = function () {
  return new Worker(__webpack_require__.p + "worker.bundle.js");
};
