...
module.exports = function() {
  return new Worker(__webpack_require__.p + "ba5e26c18079c7d48f57.worker.js");
};
    ...
    Init(config) {
      ...
      if (Object(_util__WEBPACK_IMPORTED_MODULE_0__["IsObject"])(config.axis)) {
        ...
        if (Object(_util__WEBPACK_IMPORTED_MODULE_0__["IsObject"])(config.axis.x2)) {
          ...
          this.axisX2 = new _axis__WEBPACK_IMPORTED_MODULE_1__["default"](type, visible, label, position, range);
        }
        if (Object(_util__WEBPACK_IMPORTED_MODULE_0__["IsObject"])(config.axis.y)) {
          ...
          this.axisY = new _axis__WEBPACK_IMPORTED_MODULE_1__["default"](type, visible, label, position, range);
        }
        if (Object(_util__WEBPACK_IMPORTED_MODULE_0__["IsObject"])(config.axis.y2)) {
          ...
          this.axisY2 = new _axis__WEBPACK_IMPORTED_MODULE_1__["default"](type, visible, label, position, range);
        }
      }
  ...
  InitModel(dataSet) {
    ...
    dataSet.linedatas.length
      && dataSet.linedatas.forEach((item) => {
        ...
        this.lineDatas.set(
          id,
          new _lineData__WEBPACK_IMPORTED_MODULE_1__["default"](type, axisX, axisY, legend, color, visible, datas, func, dotNum)
        );
      });
...
class GraphCanvas {
  ...
  Draw(viewModel) {
    _draw_drawHelper__WEBPACK_IMPORTED_MODULE_0__["default"].Draw(
